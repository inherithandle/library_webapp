...
$sql = "select * from book b, author a, publisher p where b.author_id = a.author_id and b.publisher_id = p.publisher_id and publisher_name like '%{$_POST['publisher_name']}%' and title like '%{$_POST['title']}%' and author_name like '%{$_POST['author_name']}%'";
//echo $sql;
//$sql = "select * from book where title like '%{$_POST['title']}%'";
