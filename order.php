...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
      ...
      <table>
        <tr>
          <th>주문 수량</th>
          <td>
        	<input type="text" name="quantity_ordered" id="quantity_ordered" value="" />
          </td>
        </tr>
        ...
        <tr>
          <th>주소:</th>
          <td>
            <input type="text" name="customer_name" id="customer_name" value="" size= "40"/>
        </tr>
	...
	<tr>
        ...
        <tr>
          <th>주민등록번호:</th>
            <td>
				<input type="text" name="social_number" id="social_number" value="" />
            </td>
	  	</tr>
		<tr>
		<th></th>
