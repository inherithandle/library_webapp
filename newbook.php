...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
        	...
        	<h2></h2><p></p>
    		<h1 id="login_message">새 책 추가 - 아래의 양식을 채우고 확인 버튼을 누르세요</h1>
        	    <form id="beanform" action="newbook_result.php" method="post">
    <p>
      <table>
        <tr>
          <th>ISBN:</th>
	...
	<tr>
        ...
        <tr>
          ...
          <tr>
            <th>출판사:</th>
            <td>
              <input type="text" name="publisher_id" id="publisher_id" value="" />
            </td>
          </tr>
