...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
        	...
        	<h2></h2><p></p>			
    		<h1 id="login_message">일별 매출액 조회입니다.</h1>
    		
    		<table>
    					<tr>
    		          <th><h1>day</h1></th>
    		          <th><h1>해당 일의 판매권수</h1></th>
    		          <th><h1>해당 일의 매출액</h1></th>
    		          </tr>
        	<?php
				...
				// monthly
				$sql = "select date_of_order as month, sum(quantity_ordered) as totalorder, sum(price * quantity_ordered) as sales from customer_history natural join book group by date_of_order;";
